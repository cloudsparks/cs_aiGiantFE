	...
	<div class="listingPageWrapper">
		<div class="text-center mt-5">
			<div class="pageTitle py-0">
				<span data-lang=""><?php echo $translations['M03710'][$language]; /* Community */ ?></span>
			</div>
		</div>
...
var thArray  = Array(
		...
		'<?php echo $translations['M03738'][$language]; /* From Username */ ?>',
		'<?php echo $translations['M03739'][$language]; /* From ROI */ ?>',
		"<?php echo $translations['M03031'][$language]; /* Percentage */ ?>",
		'<?php echo $translations['M03740'][$language]; /* Bonus Amount */ ?>'
);
