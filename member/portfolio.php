	...
	<div class="listingPageWrapper">
		<div class="text-center mt-5">
			<div class="pageTitle py-0">
				<span data-lang="M03662"><?php echo $translations['M00007'][$language] /*Portfolio*/ ?></span>
			</div>
		</div>
...
var thArray  = Array(
		...
		"<?php echo $translations['A01466'][$language] /*Reference No*/ ?>",
		"<?php echo $translations['M03657'][$language] /*Courses*/ ?>",
		"<?php echo $translations['A00549'][$language] /*Course Credit*/ ?>",
		"<?php echo $translations['M03718'][$language] /*Used*/ ?>",
		"<?php echo $translations['M03719'][$language] /*Accumulated Days*/ ?>",
	...
	if(list){
		...
		$.each(list, function(k,v){
			var rebuildData ={
				...
				maxCap : numberThousand(v['maxCap'],2),
				usedValue : numberThousand(v['tierValue'],2),
				videoAccuDay : v['videoAccuDay'],
