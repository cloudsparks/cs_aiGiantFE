...
<section class="pageContent">
	<div class="kt-container">
		...
		<div class="text-center">
			<div class="pageTitle">
				<span data-lang="M01081"><?php echo $translations['M01081'][$language]; //Trader Bonus ?></span>
			</div>
		</div>
...
var thArray  = Array(
		...
		"<?php echo $translations['M01088'][$language]; /* Line Level */ ?>",
		"<?php echo $translations['M00049'][$language]; ?>", //Percentage
		"<?php echo $translations['M01089'][$language]; /* Trader Bonus amount */ ?>",
);
