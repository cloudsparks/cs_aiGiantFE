	...
	<div class="listingPageWrapper">
		<div class="text-center mt-5">
			<div class="pageTitle py-0">
				<span data-lang="M03662"><?php echo $translations['M03662'][$language] /*Pairing Bonus*/ ?></span>
			</div>
		</div>
...
"<?php echo $translations['M03725'][$language]; ?>", //Date
"<?php echo $translations['M03726'][$language]; ?>", //Date
"<?php echo $translations['M03727'][$language]; ?>", //Date
"<?php echo $translations['M03728'][$language]; ?>", //Date
"<?php echo $translations['M03729'][$language]; ?>", //Date
"<?php echo $translations['M03730'][$language]; ?>", //Date
		// "Left Leg Username",
		// "C/F Left BV",
		// "New BV",
		// "Remaining BV",
	...
	if(list){
		...
		$.each(list, function(k,v){
			var rebuildData ={
				...
				left_bv: v['left_bv'],
				right_bv : v['right_bv'],
				bv_paired : v['bv_paired'],
				payPercentage : v['payPercentage'],
				payableAmount : v['payableAmount'],
				//  downlineUsernameLeft : v['downlineUsernameLeft'],
	            //  cf_left : numberThousand(v['cf_left'], 2),
	            //  left_bv: numberThousand(v['left_bv'], 2),
	            //  rm_left: numberThousand(v['rm_left'], 2),
	            //  downlineUsernameRight : v['downlineUsernameRight'],
	            //  cf_right : numberThousand(v['cf_right'], 2),
	            //  right_bv : numberThousand(v['right_bv'], 2),
	            //  rm_right: numberThousand(v['rm_right'], 2),
	            //  bv_paired : numberThousand(v['bv_paired'], 2),
