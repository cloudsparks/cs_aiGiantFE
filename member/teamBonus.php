	...
	<div class="kt-container">
		<div class="text-center">
			<div class="pageTitle" data-lang="M01132">
                <?php echo $translations['M01132'][$language] //Team Bonus ?>
			</div>
		</div>
					    	...
					    	<form id="searchDIV">
					    		<div class="col-12 px-0">
							        <div class="row align-items-end">
							        	<div class="col-lg-4 col-md-6 col-12 form-group date-container" id="datepicker" data-lang="M00091">
							        	    <label><?php echo $translations['M00091'][$language] /*Date*/ ?></label>
...
<script>
	...
	var thArray  = Array (
        ...
        '<span data-lang="M00036" class="bottom"><?php echo $translations['M00036'][$language]; //Username ?></span>',
        '<span data-lang="M01170" class="bottom"><?php echo $translations['M01170'][$language]; //From Level ?></span>',
        '<span data-lang="M01149" class="bottom"><?php echo $translations['M01149'][$language]; //Total Investment Amount ?></span>',
		...
		if(list){
			...
			$.each(list, function(k, v) {
				var rebuildData = {
					...
					totalInvestedAmount  	: numberThousand(v['totalInvestedAmount'],6),
