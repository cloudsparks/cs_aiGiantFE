...
function loadProduct(data, message) {
	...
	$.each(productListing, function(k, v) {
		...
		if (v['id'] == 1) {
				productDisplay += `
					<div class="col-md-3 col-6 mb-5 mb-md-0 mt-4">
						<div class="row productBg ml-1" style="background-image: url('../images/service_${v['id']}.png');">
				...
				productDisplay += `
					<div class="col-md-3 col-6 mb-5 mb-md-0 mt-4">
						<div class="productBorder">
							<div class="productBg2" style="background-image: url('../images/service_${v['id']}.png');">
								
								<!--<div class="col-md-8 col-10 px-3 py-3 mb-5" style="float: right;">
									<div class="daysDisplay">
										<img src="../images/clock_icon.png" class="mr-2"> <span class="productFont04">${v['courseDay']['value']} days course</span>
									</div>
								</div> -->
							...
							<div class="row">
								<div class="col-12 productFont05 mt-4" style="color: #000; height: 70px;">
									${v['display']}
								</div>
								<div class="col-3 productFont06">
									$${v['price']}
								</div>
								<div class="col-9 productFont07 mt-2" style="color: #000;">
									${v['rv']['value']} RP, ${v['cp']['value']} CP
								</div>
								<div class="col-12 mt-3">
									<button  class="btn btn-primary h-100 w-100 serviceBtn" onclick="submitBtn(${v['id']},${v['price']})" ${v['canPurchase'] ? '' : 'disabled'} data-lang=''><?php echo $translations['M03654'][$language]; /* Buy Now */ ?></button>
								</div>
							</div>
						</div>
					</div>
