...
<section class="pageContent">
	<div class="kt-container">
		...
		<div class="text-center">
			<div class="pageTitle">
				<span data-lang="P00015"><?php echo $translations['M01124'][$language]; //August Rank Promo ?></span>
			</div>
		</div>
...
var thArray  = Array(
		...
		"<?php echo $translations['M01128'][$language]; ?>", //Monthly AUM
		"<?php echo $translations['M01125'][$language]; ?>", //Sponsor AUM
		"<?php echo $translations['M00049'][$language]; ?>", //Percentage
		"<?php echo $translations['M01126'][$language]; ?>", //Point Earned
		"<?php echo $translations['M01118'][$language]; ?>", //Points Balance
		"<?php echo $translations['M01127'][$language]; ?>"  //New Rank
		);
