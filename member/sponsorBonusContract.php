...
<section class="pageContent">
	<div class="kt-container">
		...
		<div class="text-center">
			<div class="pageTitle">
				<span data-lang="M01072"><?php echo $translations['M01072'][$language]; /* Contract Direct Sponsor Bonus */ ?></span>
			</div>
		</div>
...
var thArray  = Array(
		...
		"<?php echo $translations['M01069'][$language]; /* Contract Type */ ?>",
		"<?php echo $translations['M01070'][$language]; /* Contract Units */ ?>",
		"<?php echo $translations['A01474'][$language]; ?> %", //Sponsor
		"<?php echo $translations['M01074'][$language]; ?>", //Sponsor Amount
...
$(document).ready(function(){
	...
	var formData  = {
	  command: 'getSponsorBonusContractReport'
	};
