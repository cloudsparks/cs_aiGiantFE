...
<html>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="searchForm" role="form">
                                                <!-- <div class="col-sm-4 form-group hide typeText">
                                                    ...
                                                    <input id="" type="text" class="form-control" dataName="type" dataType="text" value="adminSpecialBatchRegistration">
                                                </div> -->
    ...
    <script>
        ...
        $(document).ready(function() {
            /*var formData  = {command: 'getImportData', type : 'adminSpecialBatchRegistration', pageNumber: pageNumber};
            ...
            $('#upload').click(function() {
                $.redirect("addQuantumBatchRegistration.php");
            });
        ...
        function pagingCallBack(pageNumber, fCallback){
                ...
                var formData   = {
                    ...
                    type : 'adminSpecialBatchRegistration',
        ...
        function tableBtnClick(btnId) {
            ...
            if(btnName == "view") {
                $.redirect("quantumBatchRegistrationDetails.php", {id: id});
            }
        }
