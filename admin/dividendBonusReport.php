...
<script>
    ...
    function exportBtn() {
        ...
        var formData = {
            command     : "addExcelReq",
            API         : "getDividendBonusReport",
            fileName    : "DividendBonusReport",
        ...
        if(data != "" && listing.length>0) {
            ...
            $.each(listing, function(k, v) {
                ...
                var rebuildData = {
                    ...
                    // Date | Member ID | Username | Full Name | Contract Amount | Percentage | Rebate Amount
                    bonus_date      : v['bonus_date'],
                    member_id       : v['member_id'],
                    username        : v['username'],
                    fullname        : v['fullname'],
                    contract_amount : numberThousand(v['contract_amount'], 2),
