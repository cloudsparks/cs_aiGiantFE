                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-3 form-group hide">
                                                   ...
                                                   <input id="rebateType" type="text" class="input-sm form-control" name="start" dataName="bonusType" dataType="text" value="rebateQuantumBonus" readonly>
                                                </div>
                                            </div>
                                            </form>
                                            <!-- hidden -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#resetBtn').click(function() {
            ...
            $("#rebateType").val("rebateQuantumBonus");
        });
    ...
    function loadDefaultListing(data, message) {
        ...
        //     filename: 'Quantum_ROI', // (id, String), filename for the downloaded file, (default: 'id')
