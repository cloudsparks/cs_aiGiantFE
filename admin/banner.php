...
<html>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- <div class="card-box p-b-0"> -->
                                <div id="addMemo" class="btn btn-primary waves-effect waves-light m-b-20">
                                    Add Banner
                                </div>
                                <form>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // var formData  = {command: 'getBannerList'};
        ...
        function loadDefaultListing(data, message) {
            $('#basicwizard').show();
            var tableNo;
            buildTable(data.bannerList, tableId, divId, thArray, btnArray, message, tableNo);
        ...
        function tableBtnClick(btnId) {
            ...
            if(btnName == "edit") {
                $.redirect('editBanner.php', {id : id});
            }
            else if(btnName == "delete") {
                var formData  = {command : 'removeBanner', id : id};
        ...
        function removeCallback(data, message) {
            showMessage(message, 'success', 'Remove Banner', 'trash', 'Banner.php');
        }
