                                        ...
                                        <form id="searchForm" role="form">
                                            <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <span class="pull-right">
                                                            <input id="fromUsernameMatch" type="radio" name="fromUsernameType"
                                                                   value="match" checked>
                                                            <label for="fromUsernameMatch"
                                                                   style="margin-right: 15px;"><?php echo $translations['A01347'][$language]; /* Match */ ?></label>

                                                            <input id="fromUsernameLike" type="radio" name="fromUsernameType"
                                                                   value="like" style="margin-left: 15px;">
                                                            <label for="fromUsernameLike"><?php echo $translations['A01348'][$language]; /* Like */ ?></label>
                                                        </span>
                                                    <input type="text" class="form-control fromUsername" dataName="fromUsername"
                                                           dataType="text">
                                                </div>
                                                <!-- <div class="col-sm-4 form-group">
                                                    <label class="control-label">
...
<script>
    ...
    $(document).ready(function () {
        ...
        formData  = {command: 'getTraderBonusContractSubReport'};
        ...
        $('#searchBtn').click(function () {
            var getDataType = $("input[name=fromUsernameType]:checked").val();
            $('.fromUsername').attr('dataType', getDataType);
    ...
    $('#exportBtn').click(function () {
        ...
        var formData = {
            command: "getTraderBonusContractSubReport",
            filename: "TraderBonusContractSubReport",
        ...
        if (data.bonusList) {
            ...
            $.each(data.bonusList, function (k, v) {
                var rebuildData = {
                    ...
                    rebateAmount: numberThousand(v['rebateAmount'], 2),
                    lineLevel: v['lineLevel'],
