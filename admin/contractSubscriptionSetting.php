        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="container">
                                        ...
                                        <div class="panel-body">
                                            <div class="row" style="display: flex;align-items: flex-end;">
                                                <div class="col-sm-5 form-group">
                                                    ...
                                                    <select class="form-control trancheOption" data-version="V1" id="trancheOptionV1">
                                                        <option value="">--Please Select--</option>
                                                       <?php foreach($_SESSION["trancheList"] as $key => $value){ ?>
                                                            <option value="<?php echo $value['id']; ?>">
                                                                <?php echo $value['display']; ?>
                                                    ...
                                                    <span class="appendCodeError"></span>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5 form-group">
                                                    ...
                                                    <input class="form-control" id="setQuantityV1">
                                                    <!-- <span id="quantityError" class="errorSpan text-danger"></span> -->
                                                    <span class="appendQtyError"></span>
                                                </div>
                                                <div class="col-xs-12">
                                                    <button id="resetBtn" type="reset" class="btn btn-default waves-effect waves-light">
                                                        <?php echo $translations['A00053'][$language]; /* Reset */ ?>
                                                    </button>
                                                    <button onclick="submitBtn('V1')" type="button" class="btn btn-primary waves-effect waves-light">
                    ...
                    <div class="row">
                        <form id="addFormV2" role="form">
                            <div class="col-lg-12">
                                <div class="panel-group">
                                    <div class="panel panel-default bx-shadow-none">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                Update V2 Contract Headcount Setting
                                            </h4>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row" style="display: flex;align-items: flex-end;">
                                                <div class="col-sm-5 form-group">
                                                    ...
                                                    <select class="form-control trancheOption" data-version="V2" id="trancheOptionV2">
                                                        <option value="">--Please Select--</option>
                                                    ...
                                                    <!-- <select class="form-control" id="trancheOptionV2">
                                                        <option value="">--Please Select--</option>
                                                       <?php foreach($_SESSION["trancheV2List"] as $key => $value){ ?>
                                                            <option value="<?php echo $value['id']; ?>">
                                                                <?php echo $value['display']; ?>
                                                    ...
                                                    <!-- <span id="codeErrorV2" class="errorSpan text-danger"></span> -->
                                                    <span class="appendCodeError"></span>
                                                </div>
                                                <div class="col-sm-3 form-group">
                                                    <label class="control-label">
                                                    ...
                                                    <input class="form-control" id="trancheHeadcountV2" disabled style="width: 80px;">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-5 form-group">
                                                    ...
                                                    <input class="form-control" id="setQuantityV2">
                                                    <!-- <span id="quantityErrorV2" class="errorSpan text-danger"></span> -->
                                                    <span class="appendQtyError"></span>
                                                </div>
                                                <div class="col-xs-12">
                                                    <button id="resetBtnV2" type="reset" class="btn btn-default waves-effect waves-light">
                                                        <?php echo $translations['A00053'][$language]; /* Reset */ ?>
                                                    </button>
                                                    <button onclick="submitBtn('V2')" type="button" class="btn btn-primary waves-effect waves-light">
                                                        <?php echo $translations['A00323'][$language]; /* Submit */ ?>
                                                    </button>
                                                </div> 
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.trancheOption').on('change', function() { 
            trancheVersion = $(this).attr('data-version');
            var trancheCode = $(this,'.trancheOption option:selected').val();

            formData = {
                command   : 'getTrancheHeadCount',
                trancheVersion : trancheVersion,
                contractCode : trancheCode
            };
        ...
        $('#resetBtnV2').click(function() {
              $('#addFormV2').find('input:not([type=radio])').each(function() {
                  $(this).val(''); 
              });
              $('#addFormV2').find('select').each(function() {
                  $(this).val('all');
              });
          });
    ...
    function submitBtn(version){
        if(version == 'V1'){
            $('.appendQtyError').empty();
            $('.appendCodeError').empty();
            $('#addForm .appendQtyError').append('<span id="quantityError" class="errorSpan text-danger"></span>');
            $('#addForm .appendCodeError').append('<span id="codeError" class="errorSpan text-danger"></span>');
        }else{
            $('.appendQtyError').empty();
            $('.appendCodeError').empty();
            $('#addFormV2 .appendQtyError').append('<span id="quantityError" class="errorSpan text-danger"></span>');
            $('#addFormV2 .appendCodeError').append('<span id="codeError" class="errorSpan text-danger"></span>');
        }


        $('.text-danger').text("");
        var trancheCode = $('#trancheOption'+version+' option:selected').val();
        var setQuantity = $('#setQuantity'+version).val();

        var formData = {
            'command'       : 'adminSetTrancheQuantity',
            trancheVersion : version,
            contractCode     : trancheCode,
    ...
    function loadHeadCount(data, message) {
        if(trancheVersion == 'V1'){
            $('#trancheHeadcount').val(data.currentHeadcount);
        }else{
            $('#trancheHeadcountV2').val(data.currentHeadcount);
        }
        
    }

    function setTrancheQuantitySuccess(data, message) {
        showMessage(message, 'success', 'Congratulations', '', 'contractSubscriptionSetting.php');
    }
