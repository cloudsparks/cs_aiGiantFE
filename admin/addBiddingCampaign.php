                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box p-b-0">
                            ...
                            <?php echo $translations['A01696'][$language]; /* Add Bid Campaign*/ ?>
                            </h4>
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" id="addCampaign" data-parsley-validate novalidate>
                                        <div id="basicwizard" class=" pull-in">
                                            <div class="tab-content b-0 m-b-0 p-t-0">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">
                                                    <?php echo $translations['A00279'][$language] //Invoice ?> <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="input-group input-daterange">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">
                                                    <?php echo $translations['A01736'][$language] //Transaction ID ?><span class="text-danger">*</span>
                                                    </label>
                                                    <div class="input-group input-daterange">
...
-->                                                     <label><?php echo $translations['A00488'][$language] //Image?></label><span class="text-danger">*</span>
                                                        ...
                                                        <div class="col-md-4" style="width:100%;">
                                                            <div class="">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p id="emptyErr" class="err-msg"><?php echo $translations['A01738'][$language] //This value is required. ?></p>
                                                                ...
                                                                <div class="m-t-rem1">
                                                                    <a href="javascript:;" id="uploadPdfBtn" class="btn btn-primary btnUpload"><?php echo $translations['A00304'][$language]; /* Upload*/ ?></a>
                                                                    <span id="attachmentName1" class="fileName"><?php echo $translations['A01737'][$language] //No Attachment Uploaded ?></span> 
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#add').click(function() {
            ...
            var validate = $('#addCampaign').parsley().validate();
            validateDescription()
            
            if(validate && descriptionType != '') {
                showCanvas();
                var searchId   = 'addCampaign';
        ...
        if(data) {
            ...
            $('#modalProcessing').modal('show');
                ...
                if(data.image) {
                    ...
                    reqData2.append('image', data.image);
                }
            ...
            $('#modalProcessing').modal('hide');
            showMessage('<?php echo $translations['A01751'][$language] //Successfully Added Bidding Campaign ?>', 'success', '<?php echo $translations['A01752'][$language] //Add New Bidding Campaign ?>', 'user-plus', 'biddingCampaignSetting.php');
    ...
    function updateHTML(content) {
        ...
        if(descriptionContent && descriptionContent != "" && descriptionContent != null) {
            $('#uploadPdfBtn').addClass('disable-button')
        }else {
            $('#uploadPdfBtn').removeClass('disable-button')
        }
