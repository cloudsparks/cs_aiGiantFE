                                        ...
                                        <form id="searchForm" role="form">
                                            ...
                                            <div class="col-sm-12 px-0">
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control" dataName="referenceNo"
                                                           dataType="text">
                                                </div>
                                                <!-- <div class="col-sm-4 form-group">
                                                    <label class="control-label">
...
<script>
    ...
    // Bonus Date | Rank | Username | AUM | From Username | From Level | From Amount | Pay Percentage | Payable amount | Income Amount (accumulate) | Income Limit (member current income limit amount)
        ...
        if (data.bonusList) {
            ...
            $.each(data.bonusList, function (k, v) {
                var rebuildData = {
                    ...
                    portfolio_pv: numberThousand(v['portfolio_pv'], 2)
                };
