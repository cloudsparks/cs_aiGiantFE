...
<html>
                        ...
                        <div class="col-lg-12">
                            <!-- <div class="card-box p-b-0"> -->
                                <div id="addMemo" class="btn btn-primary waves-effect waves-light m-b-20">
                                    <?php echo $translations['A00423'][$language]; /* Add Memo */?>
                                </div>
                                <form>
    ...
    <script>
        ...
        function loadDefaultListing(data, message) {
            $('#basicwizard').show();
            var tableNo;
            buildTable(data.memoList, tableId, divId, thArray, btnArray, message, tableNo);
        ...
        function removeCallback(data, message) {
            showMessage('<?php echo $translations['A00432'][$language]; /* Successful remove memo. */?>', 'success', '<?php echo $translations['A00433'][$language]; /* Remove Memo */?>', 'trash', 'memo.php');
        }
