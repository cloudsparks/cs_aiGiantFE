                                                    ...
                                                    <div class="col-sm-4 form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control input-daterange-from"
                                                                   dataName="createdAt" dataType="dateRange"/>
...
<script>
    ...
    function exportBtn() {
        ...
        var formData = {
            ...
            command     : "addExcelReq",
            API         : "getPortfolioVoucherListing",
            fileName    : "VoucherListReport",
            searchData   : searchData,
            params      : exportParams,
            headerAry   : thArray,
            keyAry      : key,
            titleKey    : "voucherList",
            type        : 'export',
            returnType  : 'excel',
            usernameSearchType : $("input[name=usernameType]:checked").val()
        };
    ...
    function seeAllBtn() {
        ...
        var searchData = buildSearchDataByType(searchID);
        formData = {
            command         : 'getPortfolioVoucherListing',
            searchData      : searchData,
            pageNumber      : 1,
            seeAll          : 1
        };
    ...
    function loadDefaultListing(data, message) {
        ...
        var tableNo;
        var portfolioPageListing = data.voucherList;
