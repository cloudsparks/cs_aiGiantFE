...
<script>
    ...
    $(document).ready(function () {
        ...
        // formData  = {command: 'getReleaseBonusReport'};
    ...
    function loadDefaultListing(data, message) {
        ...
        if (data.bonusList) {
            ...
            $.each(data.bonusList, function (k, v) {
                var rebuildData = {
                    ...
                    // from_id_name: v['from_name'],
                    // from_id_username: v['from_username'],
        ...
        $('#' + tableId).find('tbody').append(`
                    <tr style="">
                        ...
                        <td style="text-align: right;"> ${addCormer(data.pagingTotal)} </td>
                        <td></td>
                    </tr>
                `);
