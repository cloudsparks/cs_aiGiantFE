                                        ...
                                        <div id="basicwizard" class=" pull-in">
                                            <div class="tab-content b-0 m-b-0 p-t-0">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="popupMemoImageWrapper default">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <textarea id="description" class="form-control limitText" rows="4" cols="50" required></textarea>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <span id="fileName1" class="fileName">No Image Uploaded</span>
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        <?php echo $translations['A00490'][$language]; /* Status */?>
                                                    </label>
                                                ...
                                                <div class="form-group hide">
                                                    ...
                                                    <div id="treeType" class="m-b-20">
                                                        ...
                                                        <div class="radio radio-inline">
                                                            <input id="sponsorRadio" type="radio" value="sponsor" name="typeRadio" checked="checked"/>
...
<script>
    ...
    $(document).on("input",".limitText",function() {
        var words = 0;
        var maxLen = 200;
        ...
        if (words > maxLen) {
          ...
          var trimmed = $(this).val().split(/\s+/, maxLen).join(" ");
          // Add a space at the end to make sure more typing creates new words
          $(this).val(trimmed + " ");

          alert('Maximum ' +maxLen+' words only.')
        }
