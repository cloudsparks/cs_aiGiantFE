...
<script>
    ...
    function exportBtn() {
        ...
        var formData = {
            command     : "addExcelReq",
            API         : "getDirectReferalBonusReport",
            fileName    : "DirectReferralReport",
            searchData   : searchData,
            params      : exportParams,
            headerAry   : thArray,
            keyAry      : key,
    ...
    function loadDefaultListing(data, message) {
        ...
        // Date | Member ID | Username | Full Name | From Username | Dividends | Percentage | Bonus Amount
                    bonus_date          : v['bonus_date'],
                    member_id           : v['member_id'],
                    username            : v['username'],
                    fullname            : v['fullname'],
                    fromUsername        : v['fromUsername'],
                    dividends           : numberThousand(v['fromamount'],2),
    ...
    function pagingCallBack(pageNumber, fCallback){
        ...
        var formData = {
            command    : "getDirectReferalBonusReport",
            searchData  : searchData,
            pageNumber : pageNumber,
            usernameSearchType : $("input[name=usernameType]:checked").val()
        };
