                                            ...
                                            <div class="col-sm-12 px-0">
                                                <div class="col-sm-3 form-group" id="datepicker">
                                                    <label class="control-label"
                                                           data-th=""><?php echo $translations['A00969'][$language]; ?></label>
                                                ...
                                                <!-- <div class="col-sm-3 form-group">
                                                    ...
                                                    <div class="form-control" style="border: none">
                                                        <input id="match" type="radio" name="fromUsernameType" value="match" checked> 
                                                        <label for="match">Match</label>

                                                        <input id="like" type="radio" name="fromUsernameType" value="like" style="margin-left: 15px;" > 
                                                        <label for="like">Like</label>
                                                    </div>
                                                </div> -->
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <span class="pull-right hide">
                                                        <input id="fmatch" type="radio" name="fromUsernameType"
                                                               value="match" checked>
                                                        <label for="fmatch" style="margin-right: 15px;">Match</label>

                                                        <input id="flike" type="radio" name="fromUsernameType"
                                                               value="like" style="margin-left: 15px;">
                                                        <label for="flike">Like</label>
                                                    </span>
                                                    <input type="text" class="form-control" dataName="from_id_username"
                                                           dataType="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <input id="memberID" type="text" class="form-control"
                                                           dataName="memberID" dataType="text">
                                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // formData  = {command: 'getWaterBucketBonusReport'};
    ...
    function pagingCallBack(pageNumber, fCallback) {
        ...
        var formData = {
            ...
            inputData: searchData,
            usernameSearchType: $("input[name=usernameType]:checked").val(),
            fromUsernameSearchType: $("input[name=fromUsernameType]:checked").val()
        };
    ...
    function loadDefaultListing(data, message) {
        ...
        if (data.bonusList) {
            ...
            $.each(data.bonusList, function (k, v) {
                var rebuildData = {
                    ...
                    bonus_amount: addCormer(v['from_amount']),
                    percentage: v['percentage'],
                    bonus_received: addCormer(v['bonus_received'])
                    // type: v['type']
                };
        ...
        $('#' + tableId).find('tbody').append(`
                    <tr style="">
                        ...
                        <td style="text-align: right;"> ${addCormer(data.page_total_bonus_received)} </td>
                        <td></td>
                    </tr>
                `);
        ...
        //     filename: 'Water_Bucket', // (id, String), filename for the downloaded file, (default: 'id')
