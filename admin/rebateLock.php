                                        ...
                                        <div class="col-sm-12 px-0">
                                            ...
                                            <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <select id="status" class="form-control" dataName="rebateLock" dataType="text">
                                                        <option value="">
                                                            <?php echo $translations['A00055'][$language]; /*all*/ ?>
                                                        </option>
                                                        <option value="1">
                                                            <?php echo $translations['A01273'][$language]; /*Locked*/ ?>
                                                        </option>
                                                        <option value="0">
                                                             <?php echo $translations['A01274'][$language]; /*Unlocked*/ ?>
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
...
<script>
   ...
   var thArray  = Array(
    ...
    $(document).ready(function() {
        ...
        // formData  = {command: 'getPortfolioListRebateLock', inputData : searchData};
    ...
    function updateCallback(data, message) {
        showMessage('<?php echo $translations['A00616'][$language]; /* Successful updated status. */ ?>', 'success', '<?php echo $translations['A00617'][$language]; /* Update Status */ ?>', 'edit', 'rebateLock.php');
    }
