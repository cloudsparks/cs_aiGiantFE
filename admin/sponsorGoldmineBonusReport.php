                                              ...
                                              <div class="col-sm-12 px-0">
                                                ...
                                                <div class="col-sm-3 form-group">
                                                    ...
                                                    <span class="pull-right hide">
                                                        <input id="fmatch" type="radio" name="fromUsernameType" value="match" checked> 
                                                        <label for="fmatch" style="margin-right: 15px;">Match</label>

                                                        <input id="flike" type="radio" name="fromUsernameType" value="like" style="margin-left: 15px;" > 
...
<script>
    ...
    $(document).ready(function() {
        ...
        // formData  = {command: 'getSponsorGoldmineBonusReport'};
    ...
    function seeAllBtn() {
        ...
        formData  = {
            command : 'getSponsorGoldmineBonusReport',
    ...
    function exportBtn(){
          ...
          var searchData = buildSearchDataByType(searchID);
            ...
            var formData  = {
                command    : "getSponsorGoldmineBonusReport",
                filename   : "SponsorGoldmineBonusReport",
                inputData  : searchData,
                header     : thArray,
                key        : key,
                DataKey    : "bonusList",
