                                        ...
                                        <form role="form" enctype="multipart/form-data">
                                            <div id="basicwizard" class=" pull-in">
                                                <div class="tab-content b-0 m-b-0 p-t-0">
                                                    ...
                                                    <span class="text-danger">Remarks: only Active , Suspend and Terminate is allowed.</span>
                                                    <br>
                                                    <div style="margin-top: 20px">
                                                    <?php $sampleFormatURL = $config['sampleFormatURL']; ?>
                                                    <b class="text-danger">*</b><a href="<?php echo $sampleFormatURL ?>batchStatusAdjustment.xlsx" style="margin-left: 10px">click here to download sample excel format</a>
                                                    <!-- <div class="form-group" style="margin-top: 10px;">
                                                    <?php $sampleFormatURL = $config['sampleFormatURL']; ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#backBtn').click(function() {
                $.redirect('batchStatusAdjustment.php');
            });
            
            $('#submitBtn').click(function() {
                $('.errorSpan').empty();
                var form = new FormData();
                form.append('command', 'adminBatchStatusAdjustment');
        ...
        function submitCallback(data, message) {
            showMessage('<?php echo $translations['A00324'][$language]; /* Upload successful. */?>', 'success', '<?php echo $translations['A00325'][$language]; /* Upload File */?>', 'upload', 'batchStatusAdjustment.php');
        }
    </script>
</body>
</html>