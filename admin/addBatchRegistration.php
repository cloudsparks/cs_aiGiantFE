                                        ...
                                        <form role="form" enctype="multipart/form-data">
                                            <div id="basicwizard" class=" pull-in">
                                                <div class="tab-content b-0 m-b-0 p-t-0">
                                                    ...
                                                    <b class="text-danger">*</b><a href="<?php echo $sampleFormatURL ?>normalBatch.xlsx" style="margin-left: 10px">click here to download sample excel format</a>
                                                      <div class="form-group" style="margin-top: 10px;">
                                                    <?php $sampleFormatURL = $config['sampleFormatURL']; ?>
                                                    <b class="text-danger">*</b><a href="<?php echo $sampleFormatURL ?>dialingAreaNew.xlsx" style="margin-left: 10px">click here to download sample dialing area excel format</a>
                                                    </div>
                                                    </div>
                                                    </div>
