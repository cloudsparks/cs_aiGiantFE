...
<html>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- <div class="card-box p-b-0"> -->
                                <div id="addAnnouncement" class="btn btn-primary waves-effect waves-light m-b-20">
                                    <?php echo $translations['A00473'][$language]; /* Add Announcement */?>
                                </div>
                                <form>
    ...
    <script>
        ...
        var thArray  = Array (
            ...
            '<?php echo $translations['A00318'][$language]; /* Status */?>',
            '<?php echo $translations['A00478'][$language]; /* Creator Username */?>',
            '<?php echo $translations['A00112'][$language]; /* Created At */?>',
            '<?php echo $translations['A00377'][$language]; /* Updated At */?>'
        );
        ...
        $(document).ready(function() {
            ...
            // var formData  = {command: 'getAnnouncementList'};
        ...
        function loadDefaultListing(data, message) {
            $('#basicwizard').show();
            var tableNo;
            buildTable(data.announcementList, tableId, divId, thArray, btnArray, message, tableNo);
        ...
        function tableBtnClick(btnId) {
            ...
            if(btnName == "edit") {
                $.redirect('editAnnouncement.php', {id : id});
            }
            else if(btnName == "delete") {
                var formData  = {command : 'removeAnnouncement', id : id};
        ...
        function removeCallback(data, message) {
            showMessage('<?php echo $translations['A00481'][$language]; /* Successful remove announcement. */?>', 'success', '<?php echo $translations['A00482'][$language]; /* Remove Announcement */?>', 'trash', 'announcement.php');
        }
